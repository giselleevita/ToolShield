...
from toolshield.data.make_splits import SplitProtocol, create_splits
...
def check_attack_holdout_constraints(splits: dict[str, list[DatasetRecord]]) -> tuple[bool, str]:
...
def check_tool_holdout_constraints(splits: dict[str, list[DatasetRecord]]) -> tuple[bool, str]:
...
def main() -> int:
    ...
    for protocol in [
        SplitProtocol.S_RANDOM,
        SplitProtocol.S_ATTACK_HOLDOUT,
        SplitProtocol.S_TOOL_HOLDOUT,
    ]:
