...
\subsection{Interpretation of Baseline Model Performance (RQ1)}
...
\subsection{Generalization Under Distribution Shift (RQ2)}
...
\subsection{Truncation Bias as a Catastrophic Failure Mode (RQ3, H1, H2)}
