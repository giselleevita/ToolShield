...
\subsection{Security Challenges in Tool-Using LLM Systems}
...
\subsection{LLM Safety Filters and Classification-Based Defenses}
...
\subsection{Context-Aware Modeling and Instruction Hierarchies}
...
\subsection{Context Window Limitations and Truncation Effects}
...
\subsection{Synthetic Benchmarks and Security Evaluation Datasets}
...
\subsection{Positioning of ToolShield}
