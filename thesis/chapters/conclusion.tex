...
This thesis demonstrates that prompt-preserving truncation is a necessary design principle for robust prompt injection detection in context-augmented LLM tool-use systems, and provides a reproducible benchmark pipeline that empirically validates this failure mode under enterprise-length tool schemas.
