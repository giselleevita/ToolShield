...
\subsubsection{Split generation}
...
\subsubsection{Long-schema inflation}
...
\subsection{Evaluation and Reporting Pipeline}
...
\subsubsection{LaTeX table generation}
...
\subsubsection{Truncation statistics}
...
\subsection{Experiment Folder Structure}
...
\subsubsection{Deterministic splits}
...
\subsubsection{Run manifests and environment freeze}
...
\subsection{Artifacts and Experiment Bundle}
